...
public final class ExampleViewModel: ComponentViewModel, ObservableObject {
    ...
    public init(properties: ExampleProperties,
        ...
        self.primaryButton = .init(properties: .init(title: "Go to details", style: .primary, navigation: .init(navigationType: .push("fullScreen"), deferredLoadingWorkId: nil, additionalProperties: nil)),
